...
import SSSGWeekly from "../components/SSSGWeekly";
...
const VIEWS = [
  ...
  { key: "sssg-weekly", label: "Weekly SSSG",   short: "Wk SSSG",   icon: "gauge",     group: "Stores",     roles: ["admin"] },
