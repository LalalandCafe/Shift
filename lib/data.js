...
// ESCRITOR NO CANONICO, Y SIN NINGUN LLAMADOR.
//
// Nada en app/, lib/ ni components/ llama a esta funcion - verificado por
// grep. Queda como codigo muerto.
//
// Ademas esta incompleta desde docs/sql/007: escribe gross_sales pero no
// discounts_amount ni refunds_amount, asi que cualquier fila que escriba
// tendria net_sales en NULL (net_sales es GENERATED y necesita los dos
// componentes). El escritor canonico de daily_sales es
// app/api/toast/sync-store/route.js, que si los calcula.
//
// Si alguna vez se le da un llamador, portar el calculo de
// discountsForCheck/refundsForCheck (lib/toast.js) primero.
